...
public class SettingController extends Application implements GameMenuBar
{
    ...
    public static VBox createMenuInVBox (Stage stage, Pane root, int itemWidth, int itemHeight, int xPositionVBox, int yPositionVBox)
    {
        VBox box = new VBox(Constants_MenuSetting.VBOX_V,
                new TransparentButton(Constants_MenuSetting.MENU_CONTINUE_GAME,() -> {}, itemWidth, itemHeight), // -> continueGame(), 200, 30),
                new TransparentButton(Constants_MenuSetting.MENU_NEW_GAME,() -> {}, itemWidth, itemHeight),
                new TransparentButton(Constants_MenuSetting.MENU_LOAD_GAME, () -> {}, itemWidth, itemHeight), // -> loadGame(stage), 200, 30),
                new TransparentButton(Constants_MenuSetting.MENU_MULTIPLAYER,() -> {}, itemWidth, itemHeight),//openSettings(stage, root), itemWidth, itemHeight),
                new TransparentButton(Constants_MenuSetting.MENU_SETTINGS, () -> {}, itemWidth, itemHeight),
    ...
    //TODO: main methode muss entfernt werden
